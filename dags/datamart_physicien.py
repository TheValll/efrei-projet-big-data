...
GOLD_APP     = "/opt/airflow/spark/gold_physicien.py"
DATAMART_APP = "/opt/airflow/spark/datamart_physicien.py"


@dag(
    dag_id="datamart_physicien",
    schedule="@daily",
    start_date=datetime(2026, 1, 1),
    catchup=False,
    max_active_runs=1,
    tags=["gold", "datamart", "physicien", "spark"],
)
def datamart_physicien():
    spark_conf = {
