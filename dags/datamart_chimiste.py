...
GOLD_APP     = "/opt/airflow/spark/gold_chimiste.py"
DATAMART_APP = "/opt/airflow/spark/datamart_chimiste.py"


@dag(
    dag_id="datamart_chimiste",
    schedule="@daily",
    start_date=datetime(2026, 1, 1),
    catchup=False,
    max_active_runs=1,
    tags=["gold", "datamart", "chimiste", "spark"],
)
def datamart_chimiste():
    spark_conf = {
